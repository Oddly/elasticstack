...
| Role | Purpose |
|------|---------|
| [elasticstack](Roles-elasticstack) | Shared defaults used by all other roles (ports, group names, CA settings, repository URLs) |
| [elasticsearch](Roles-elasticsearch) | Elasticsearch nodes — cluster formation, JVM tuning, security setup, rolling upgrades |
...
See the [Getting Started](Getting-Started) guide for a full walkthrough, or the [Architecture](Architecture) page for how the roles interact.
